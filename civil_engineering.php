			...
			<div class="about-section container-fluid no-left-padding no-right-padding">
				...
				<div class="container">
					<div class="section-header">
						<h3 style="text-transform:none">Civil Engineering</h3>
					</div>
					<div class="row">
						...
						<div class="col-md-5 col-sm-12 col-xs-12">
							<div class="about-content">
								<img alt="blog" src="assets/images/slider/02_02.jpg" width="100%" style="border-radius:10px"><br><br>
							</div>
						</div>
						...
						<div class="col-md-5 col-sm-12 col-xs-12">
							<div class="about-content">
								...
								<ul style="text-align:left;list-style-position:outside; padding-left:0;margin-left:18px;padding-bottom:25px;line-height:25px">
									...
									<li><font color="#1e1e1e">Commercial Buildings & Plazas</font></li>
									<li><font color="#1e1e1e">Restaurants</font></li>
									<li><font color="#1e1e1e">Renovations</font></li>
								</ul>
