...
<head>
	...
	<script type="application/ld+json">
	{
		...
		"itemListElement": [
			...
			{ "@type": "ListItem", "position": 2, "name": "Structural Engineering", "item": "https://www.delta-engineering.ca/structural_engineering.php" }
		]
	}
	</script>
	...
	<main>
		...
		<div class="de-cta-band">
			<div class="de-cta-band-inner">
				<div>
					<h2><?= $deLoc === 'india' ? 'Have a project in India?' : 'Have a structure to design?' ?></h2>
